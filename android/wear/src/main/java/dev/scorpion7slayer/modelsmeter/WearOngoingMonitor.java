...
public final class WearOngoingMonitor {
    public static final String ACTION_REFRESH = "dev.scorpion7slayer.modelsmeter.action.WEAR_REFRESH";
    public static final String ACTION_STOP = "dev.scorpion7slayer.modelsmeter.action.WEAR_STOP";
    ...
    private static boolean post(Context context, UsageSnapshot snapshot) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setContentTitle(dev.scorpion7slayer.modelsmeter.Translations.t("Codex usage"))
                .setContentText(dev.scorpion7slayer.modelsmeter.Translations.t(contentText))
