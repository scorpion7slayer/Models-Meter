...
public final class UpdateActivity extends AppCompatActivity {
    ...
    private void requestInstall() {
        ...
        if (!canInstallPackages()) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(dev.scorpion7slayer.modelsmeter.Translations.t("Allow app installs"))
                    .setMessage(dev.scorpion7slayer.modelsmeter.Translations.t("Android requires permission for Models Meter to hand its verified "
    ...
    private void setStatus(String message, int color) {
        ...
        status.setText(dev.scorpion7slayer.modelsmeter.Translations.t(message));
        status.setVisibility(message == null || message.isEmpty() ? View.GONE : View.VISIBLE);
    }

    private void confirmOlderDownload() {
        new AlertDialog.Builder(this)
                .setTitle(dev.scorpion7slayer.modelsmeter.Translations.t("Downgrade requires uninstalling"))
                .setMessage(dev.scorpion7slayer.modelsmeter.Translations.t("Android blocks in-place downgrades for ordinary apps. Uninstalling "
