...
public final class Ui {
    ...
    public static void configureReachToolbar(ToolbarLayout toolbar, String title, boolean back) {
        toolbar.setTitle(dev.scorpion7slayer.modelsmeter.Translations.t(title));
    ...
    public static TextView text(Context context, String str, float f, int i) {
        ...
        textView.setText(dev.scorpion7slayer.modelsmeter.Translations.t(str));
    ...
    public static Separator separator(Context context, String title) {
        ...
        separator.setText(dev.scorpion7slayer.modelsmeter.Translations.t(title));
        return separator;
    }
    ...
    public static Button button(Context context, String str, boolean z, boolean z2) {
        ...
        button.setText(dev.scorpion7slayer.modelsmeter.Translations.t(str));
    ...
    public static Button nativePrimaryButton(Context context, String text) {
        ...
        button.setText(dev.scorpion7slayer.modelsmeter.Translations.t(text));
    ...
    public static SeslProgressBar indeterminateLoading(Context context, String description) {
        ...
        if (description != null && !description.isEmpty()) {
            loading.setContentDescription(dev.scorpion7slayer.modelsmeter.Translations.t(description));
    ...
    public static Spinner spinner(final Context context, String[] strArr, final boolean z) {
        ...
        spinner.setAdapter((SpinnerAdapter) new ArrayAdapter<String>(context, android.R.layout.simple_spinner_item, Translations.labels(strArr)) { // from class: dev.scorpion7slayer.modelsmeter.Ui.1
    ...
    public static CheckBox checkbox(Context context, String str, boolean z, boolean z2) {
        ...
        checkBox.setText(dev.scorpion7slayer.modelsmeter.Translations.t(str));
    ...
    public static void configureSystemBars(Activity activity, View view, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: dev.scorpion7slayer.modelsmeter.Ui.2
    ...
    public static void chooseProvider(Context context, Runnable onSelected) {
        new androidx.appcompat.app.AlertDialog.Builder(context)
                .setTitle(L10n.text(context, "Account · Provider", "Compte · Fournisseur"))
                .setSingleChoiceItems(Provider.labels(), ProviderRepository.selected(context).ordinal(),
                        (dialog, which) -> {
                            ProviderRepository.select(context, Provider.values()[which]);
                            dialog.dismiss();
                            onSelected.run();
                        })
                .setNeutralButton(L10n.text(context, "Manage accounts", "Gérer les comptes"),
                        (dialog, which) -> context.startActivity(new Intent(context, ProvidersActivity.class)))
                .setNegativeButton(android.R.string.cancel, null).show();
    }

    public static CardItemView providerOption(Context context, Spinner selection) {
        CardItemView row = actionRow(context, L10n.text(context, "Provider", "Fournisseur"),
                Provider.labels()[selection.getSelectedItemPosition()], 0, null);
        row.setClickable(true);
        row.setFocusable(true);
        row.setOnClickListener(view -> OneUiChoiceDialog.show(context,
                L10n.text(context, "Provider", "Fournisseur"), Provider.labels(),
                selection.getSelectedItemPosition(), which -> {
                    selection.setSelection(which);
                    row.setSummary(Provider.labels()[which]);
                }));
        return row;
    }
    ...
    public static CardItemView actionRow(Context context, String title, String summary, int icon, View.OnClickListener listener) {
        ...
        row.setSummary(dev.scorpion7slayer.modelsmeter.Translations.t(summary));
        if (icon != 0) {
