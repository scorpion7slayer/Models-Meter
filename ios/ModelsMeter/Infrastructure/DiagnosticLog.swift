...
enum DiagnosticLog {
    static let unlockKey = "models-meter.diagnostics-unlocked-v1"
    private static let enabledKey = "models-meter.diagnostics-enabled-v1"
    private static let sessionKey = "models-meter.diagnostics-session-v1"
    ...
    static func exportURL() throws -> URL {
        ...
        let export = FileManager.default.temporaryDirectory
            .appendingPathComponent("models-meter-diagnostics.jsonl")
    ...
    private static func directoryURL() -> URL {
        ...
        return base
            .appendingPathComponent("ModelsMeter", isDirectory: true)
