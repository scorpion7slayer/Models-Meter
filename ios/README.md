# Models Meter for iPhone and iPad

Native SwiftUI client for ChatGPT, Claude, Cursor, and OpenCode Go allowances.
Version 1.0.1 adds independent provider connections, model catalogs and alerts,
provider selection in WidgetKit, and System/Français/English language settings.
See [provider capabilities and authentication](../docs/PROVIDERS.md).
For ChatGPT, it shows adaptive standard and model-specific usage windows,
...
This directory is the **iOS** package of the Models Meter monorepo. The Android
