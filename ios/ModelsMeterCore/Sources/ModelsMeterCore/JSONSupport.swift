...
public enum ModelsMeterParsingError: Error, Sendable, Equatable {
    case invalidRootObject
}

extension ModelsMeterParsingError: LocalizedError {
...
enum JSONSupport {
    ...
    static func object(from data: Data) throws -> Object {
        ...
        guard let object = value as? Object else {
            throw ModelsMeterParsingError.invalidRootObject
        }
        return object
    }
