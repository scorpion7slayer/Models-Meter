...
final class ModelsMeterURLProtocol: URLProtocol, @unchecked Sendable {
...
func makeStubbedSession() -> URLSession {
    ...
    configuration.protocolClasses = [ModelsMeterURLProtocol.self]
...
func temporaryFileURL(_ name: String = UUID().uuidString) -> URL {
    FileManager.default.temporaryDirectory
        .appendingPathComponent("ModelsMeterTests-\(name)")
}
